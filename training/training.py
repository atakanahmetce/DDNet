...
def loader(num):
    ...
    file_X = '../data_folder/training_data/mp_X_h2_sim3.txt'
    file_y = '../data_folder/training_data/mp_y_h2_sim3.txt'
...
def train(X_train, y_train, ml_type = 'rf',deep_param = None, isValid = False):
